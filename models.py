...
class Eventos(models.Model):
    ...
    tipo_evento = models.CharField(max_length=255,null=True, blank=True)
    fecha_realizacion = models.DateTimeField(auto_now_add=False, null=True, blank=True)
    hora_inicio = models.TimeField(auto_now_add=False, null=True, blank=True)
    hora_fin = models.TimeField(auto_now_add=False, null=True, blank=True)
    ...
    cupo_maximo = models.CharField(max_length=255,null=True, blank=True)
    
    def __str__(self):
        return "Perfil del evento "+self.name